...
import se.tetris.component.InnerBoard;
...
public class BattleBoardUI extends JFrame implements Sizeable {
    private static InnerBoardUI player1;
    private static InnerBoardUI player2;
    ...
    public BattleBoardUI() {
        ...
        player1 = new InnerBoardUI();
        player2 = new InnerBoardUI();
        ...
        playerKeyListener = new BattleBoardUI.PlayerKeyListener();
